                                ...
                                <div class="tab-inn">
                                    <form method="POST">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" name="sub_id" class="validate" required>
                                                <label>Subject id</label>
                                            </div>
                                        </div>   
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" name="sub_name" class="validate" required>
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            $id=$_POST['sub_id'];
                                            $name=$_POST['sub_name'];
                                            $check_dup="SELECT * FROM subject WHERE sub_id='$id'";
                                            $result=$conn->query($check_dup);
                                            if($result->num_rows>0)
                                            {
                                                echo "<br>";
                                                echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Sub ID already Exist</h4>";
                                            }
                                            else
                                            {
                                                ...
                                                if($conn->query($sql))
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Subject Added Successfully!!</h4>";
                                                }
                                                else
                                                {
                                                    echo "error";
