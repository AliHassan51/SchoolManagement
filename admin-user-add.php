                                ...
                                <div class="tab-inn">
                                    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"];?>">
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="rollno" class="validate" required>
                                                <label class="">Rollno</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="fname" class="validate" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input type="text" class="validate" name="religion" value="" required>
                                                <label class="">Religion</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="medium" class="validate">
                                                <label class="">Medium</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="father_name" class="validate">
                                                <label class="">Father name</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="father_occupation" class="validate">
                                                <label class="">Father Occupation</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="guard" class="validate">
                                                <label class="">Gurdian Address</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="pob" class="validate">
                                                <label class="">Place of Birth</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="lang" class="validate">
                                                <label class="">Language</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="number" value="" name="phone" class="validate">
                                                <label class="">Phone </label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="date" value="" name="date" class="validate">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                             ...
                                             <?php
                                                include 'conn.php';
                                                $result=$conn->query("SELECT class_id FROM class");
                                             ?>
                                             ...
                                             <?php
                                               while($rows=$result->fetch_assoc())
                                               {
                                                   ...
                                                   $class_id_name=$class_id."-->".$class_name;
                                                   echo "<option value='$class_id'>$class_id_name</option>";
                                               }
                                             ?>
                                             </select>
                                            </div>
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $date=$_POST['date'];
                                            $class=$_POST['class'];
                                             $sql="INSERT INTO student(Rollno,fname,lname,relegion,father_name,father_occupation,GuardPostAddress,pob,Lang,phone,DateOfAdmission,Medium,class_id) VALUES('$rollno','$fname','$lname','$religion','$father_name','$father_occupation','$guard','$pob','$language','$phone','$date','$medium','$class')";
                                                if($conn->query($sql))
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Studnet Added Successfully!!</h4>";
                                                }
                                                else
                                                {
                                                    echo "error";
