...
<head>
    <title>Assigned Subject Information</title>
    <!-- META TAGS -->
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Assigned Subject Details</h4>
                                </div>
                                <div class="tab-inn">
                                <?php
                                    error_reporting(0);
                                    include 'conn.php';
                                    $sql="SELECT teacher.fname,teacher.lname,subject.sub_name,class.class_name FROM sub_teach_class 
                                            INNER JOIN teacher on sub_teach_class.teacher_id=teacher.t_id
                                            INNER JOIN subject on sub_teach_class.subject_id=subject.sub_id
                                            INNER JOIN class on sub_teach_class.class_id=class.class_id";
