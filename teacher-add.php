            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="teacher-add.php"> Add new Teaher</a>
                        </li>
                                    ...
                                    <form method="POST"  action="<?php echo $_SERVER["PHP_SELF"];?>">
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="number" value="" name="teacher_id" class="validate" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input type="text" name="address" class="validate" value="" required>
                                                <label class="">Address</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="qual" class="validate" required>
                                                <label class="">Qualification</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="phone" class="validate" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input type="date" value="" name="joindate" class="validate" required>
                                                <label class="">Joining date</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="date" value="" name="DOB" class="validate" required>
                                         ...
                                         <div class="row">
                                            <div class="input-field col s12">
                                                <i class="waves-effect waves-light btn-large waves-input-wrapper" name ="submit"style=""><input type="submit" name="submit" class="waves-button-input"></i>
                                            </div>
                                        </div>
                                    </form>
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $dob=$_POST['DOB'];
                                            $check_dup="SELECT * FROM teacher WHERE t_id='$id'";
                                            $result=$conn->query($check_dup);
                                            if($result->num_rows>0)
                                            {
                                                echo "<br>";
                                                echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Teacher ID already Exist</h4>";
                                            }
                                            else
                                            {
                                                $sql="INSERT INTO teacher VALUES('$id','$fname','$lname','$address','$qual','$phone','$sal','$joindate','$dob')";
                                                if($conn->query($sql))
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>TEacher Added Successfully</h4>";
                                                }
                                                else
                                                {
                                                    echo "error";
