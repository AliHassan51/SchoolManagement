                    ...
                    <div class="row">
                       ...
                       <div class="tab-inn">
                                ...
                                $total=0;
                                    ...
                                    $sql="SELECT student.Rollno, student.fname, student.lname, subject.sub_name, result.obtained_marks, result.total_marks
                                    FROM student
                                    INNER JOIN result on student.Rollno = result.RollNo
                                    LEFT join exam ON result.exam_id = exam.exam_id
                                    LEFT join subject ON result.sub_id = subject.sub_id
                                    LEFT JOIN class on student.class_id = class.class_id
                                    WHERE student.Rollno = '$roll' AND class.class_name = '$class' AND class.Academic_year = '$year' AND exam.term = '$term'";
                                ...
                                echo '<div class="row" style="text-align:left;color:black;margin:-10px 30px 20px 30px;">
                                    ...
                                    <div class="table-responsive table-desi">
                                        <table class="table table-hover">
                                            ...
                                            {
                                                $total=$total+$row[obtained_marks];
                                            echo' <tr>
                                                <td>'.$row[sub_name].'</td>
                                            ...
                                            echo '<tr style="background-color:#002147;color:white">
                                                    <td colspan=2 style="text-align:center;color:white"> Result Notification: '.$total.'</td>
                                                    </tr>';
                                            echo"</tbody>
