						...
						<div class="box-inn-sp admin-form">
                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12" >
                                                <input type="text" value="" name="fees_id" class="validate" required> 
                                                <label>Fee ID</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="number" value="" name="Amount" class="validate" required>
                                                <label>Amount</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $month=$_POST['month'];
                                                ...
                                                $sql="INSERT INTO fees VALUES('$id','$Amount','$class','$month')";
                                                if($conn->query($sql))
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Fee Record Added Successfully!!</h4>";
                                                    
                                                }
                                                else
                                                {
                                                echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Fee Record already Exist</h4>";
