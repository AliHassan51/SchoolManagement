                                    ...
                                    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"];?>">
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="" name="class_id" class="validate" required>
                                                <label>Class ID</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="" name="class_name" class="validate" required >
                                                <label>Name</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="number" value="" name="Academic_year" class="validate" required>
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $Academic_year=$_POST['Academic_year'];
                                                ...
                                                $sql="INSERT INTO class(class_id,class_name,Academic_year) VALUES('$id','$name','$Academic_year')";
                                                if($conn->query($sql))
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Class Added Successfully!!</h4>";
                                                    
                                                }
                                                else
                                                {
                                                echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Class ID already Exist</h4>";
