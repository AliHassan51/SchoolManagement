            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Add Result</a>
                        </li>
                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="row">
                                            <div class="input-field col s12">
                                             ...
                                             <?php
                                                include 'conn.php';
                                                $result=$conn->query("SELECT Rollno FROM student");
                                             ?>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                             ...
                                             <?php
                                                include 'conn.php';
                                                $result=$conn->query("SELECT exam_id FROM exam");
                                             ?>
                                             ...
                                             <?php
                                                while($rows=$result->fetch_assoc())
                                                {
                                                    ...
                                                    echo "<option value='$exam_id'>$exam_id</option>";
                                                }
                                             ?>
                                             </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                             ...
                                             <?php
                                                include 'conn.php';
                                                $result=$conn->query("SELECT sub_id FROM subject");
                                             ?>
                                             ...
                                             <?php
                                                ...
                                                {
                                                    $sub_id=$rows['sub_id'];
                                                    echo "<option value='$sub_id'>$sub_id</option>";
                                                }
                                             ?>
                                             </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="number" value="" name-="tmarks" class="validate" required>
                                                <label>Total Marks</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="number" value="" name-="ob_marks" class="validate" required >
                                            ...
                                            <div class="row">
                                            <div class="input-field col s12">
                                                <i class="waves-effect waves-light btn-large waves-input-wrapper" style=""><input type="submit" class="waves-button-input" name="submit"></i>
                                            </div>
                                        </div>
                                    </form>
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $obtained_marks=$_POST['ob_marks'];
                                             $sql="INSERT INTO result VALUES('$rollno','$exam','$subject','$totalmarks','$obtained_marks')";
                                                if($conn->query($sql))
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Result Added Successfully!!</h4>";
                                                }
                                                else
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Result Already Exist </h4>";
                                                }
                                            }
                                    ?>
                                </div>
