            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Add Exam</a>
                        </li>
                                ...
                                <div class="tab-inn">
                                    <form method="POST"  action="<?php echo $_SERVER["PHP_SELF"];?>">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" name="exam_id" class="validate" required>
                                                <label>Exam id</label>
                                            </div>
                                        </div>   
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" name="term" class="validate" required>
                                                <label>Term Name</label>
                                            </div>
                                        </div>    
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="number" name="exam_year" class="validate" required>
                                                <label>Year</label>
                                            </div>
                                        </div>                                     
                                        <div class="row">
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            $id=$_POST['exam_id'];
                                            $term=$_POST['term'];
                                            $exm_year=$_POST['exam_year'];

                                            $check_dup="SELECT * FROM exam WHERE exam_id='$id'";
                                            $result=$conn->query($check_dup);
                                            if($result->num_rows>0)
                                            {
                                                echo "<br>";
                                                echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Exam ID already Exist</h4>";
                                            }
                                            else
                                            {
                                                $sql="INSERT INTO exam VALUES('$id','$term','$exm_year')";
                                                if($conn->query($sql))
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Exam Added Successfully!!</h4>";
                                                }
                                                else
                                                {
                                                    echo "error";
