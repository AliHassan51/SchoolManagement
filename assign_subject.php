                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    <h4>Assign Subject To Teachers</h4>
                                </div>
                                <div class="tab-inn">
                                    ...
                                    <div class="row">
                                            <div class="input-field col s12">
                                             ...
                                             <?php
                                                include 'conn.php';
                                                $result=$conn->query("SELECT t_id,fname FROM teacher");
                                             ?>
                                             ...
                                             <?php
                                                while($rows=$result->fetch_assoc())
                                                {
                                                    ...
                                                    $name=$rows['fname'];
                                                    $final=$id."-".$name;
                                                    echo "<option value='$id'>$final</option>";
                                                }
                                             ?>
                                             </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                             ...
                                             <?php
                                                include 'conn.php';
                                                $result=$conn->query("SELECT sub_id,sub_name FROM subject");
                                             ?>
                                             ...
                                             <?php
                                                while($rows=$result->fetch_assoc())
                                                {
                                                    ...
                                                    $id_name=$sub_id."->".$sub_name;
                                                    echo "<option value='$sub_id'>$id_name</option>";
                                                }
                                             ?>
                                             </select>
                                            </div>
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            $subject=$_POST['subject'];
                                             $sql="INSERT INTO sub_teach_class VALUES('$subject','$teacher','$class')";
                                                if($conn->query($sql))
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Subject Assigned Successfully!!</h4>";
                                                }
                                                else
                                                {
                                                    echo "<h4 style='background: #002147; width:100%;color:white; text-align:center;'>Record Already Exist </h4>";
                                                }
                                            }
                                    ?>
                                </div>
