...
<head>
    <title>Get Class Result Position Wise</title>
    <!-- META TAGS -->
    <meta charset="utf-8">
                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    <h4>Find Class Result Result Position Wise</h4>
                                </div>
                                <div class="tab-inn">
                                    <form method="POST" action="disp_get_result_by_class_position.php">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="" name="exam_year" class="validate" required >
                                                <label>Exam Year</label>
                                            </div>
                                        
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="" name="term" class="validate" required>
                                                <label>Term</label>
                                            </div>
                                        </div>
